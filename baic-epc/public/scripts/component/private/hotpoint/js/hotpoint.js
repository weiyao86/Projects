    ...
    function setup(templates) {
        ...
        Hotpoint.prototype = (function () {
            return {
                ...
                buildDomEl: function () {
                    var self = this, html = self.getLegendHTML();
                ...
                buildCoord: function (data) {
                    var self = this,
                        radius = self.radius, callout, i = 0, j = 0, k = 0, el,
                        x = 0, y = 0, minX = 0, maxX = 0, minY = 0, maxY = 0, key,
                ...
                zoomLegend: function (delta, e) {
                    var self = this, percent = 1, position,
                        zoom = 1.2, newH = 0, newW = 0,
                ...
                legendToCenter: function (x, y) {
                    ...
                    if ((legend.cssTop === 0 && legend.cssLeft === 0)
                        && (legend.width === self.legendWidth && legend.height === self.legendHeight)) {
                        return;
                    }
                    self.$legend.css({
                        "left": moveLeft + "px",
