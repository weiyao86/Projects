Ext.define('SPDM.view.standardName.partStructureStandardName.propertyBasic.PropertyBasic', {
	extend: 'Ext.panel.Panel',
	alias: 'widget.partstructurestandardnamepropertybasicpropertybasic',
	requires: [
		'SPDM.view.standardName.partStructureStandardName.propertyBasic.PropertyBasicPG',
		'SPDM.view.standardName.partStructureStandardName.propertyBasic.PropertyBasicPS',
		'SPDM.view.standardName.partStructureStandardName.propertyBasic.PropertyBasicAS',
		'SPDM.view.standardName.partStructureStandardName.propertyBasic.PropertyBaseReference',
		'SPDM.view.standardName.partStructureStandardName.propertyBasic.PropertyBaseReport'
	],
	border: false,
	bodyPadding: 15,
	autoScroll: true,
	...
	resetProperty: function(isRoot) {
		...
		me.controlToolbar(true,isRoot);
		activePanel.getForm().reset();
	},
	controlToolbar: function(disabled,isRoot) {
		var me = this,
			buttons = me.query('toolbar > button[singleSelectEnable]');

		Ext.each(buttons, function(btn) {
		    if(isRoot && btn.itemId === 'add'){
