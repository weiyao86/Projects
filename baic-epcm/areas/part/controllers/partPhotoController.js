...
var partPhotoController = new gu.controller.inherit(baseController);
  ...
  index: {
    GET: function (req, res) {
      ...
      var options = {
        ...
        port: 8080,
        //
        path: serverConfig.requestPrefix[0] + '/part-photo/list',
        method: 'POST',
    ...
    POST: function (req, res) {
      var options = {
        ...
        port: 8080,
        //
        path: serverConfig.requestPrefix[0] + '/part-photo',
        method: 'POST',
        contentType: 'application/json',
        data: req.body,
        req: req
